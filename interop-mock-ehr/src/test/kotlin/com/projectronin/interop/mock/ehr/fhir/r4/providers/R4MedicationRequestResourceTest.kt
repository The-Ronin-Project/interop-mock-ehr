...
class R4MedicationRequestResourceTest : BaseMySQLTest() {
    ...
    fun initTest() {
        ...
        every { database.createCollection(MedicationRequest::class.java) } returns SafeXDev.SafeCollection(
            "resource",
            collection
        )
    ...
    fun `search by date range using only lower bound`() {
        ...
        val output = medicationRequestProvider.search(
    ...
    fun `search by date range using only upper bound`() {
        ...
        val dosage = Dosage()
        dosage.timing.repeat.bounds = period
        val testMedicationRequest3 = MedicationRequest()
            .addDosageInstruction(dosage)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
        ...
        val dosage2 = Dosage()
        dosage2.timing.repeat.bounds = period2
        val testMedicationRequest4 = MedicationRequest()
            .addDosageInstruction(dosage2)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
    ...
    fun `search by date range using both bounds`() {
        ...
        val dosage = Dosage()
        dosage.timing.repeat.bounds = period
        val testMedicationRequest5 = MedicationRequest()
            .addDosageInstruction(dosage)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
        ...
        val dosage2 = Dosage()
        dosage2.timing.repeat.bounds = period2
        val testMedicationRequest6 = MedicationRequest()
            .addDosageInstruction(dosage2)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
        ...
        val testMedicationRequest7 = MedicationRequest()
    ...
    fun `search by date range with cerner param using lower bound`() {
        ...
        val dosage = Dosage()
        dosage.timing.repeat.bounds = period
        val testMedicationRequest8 = MedicationRequest()
            .addDosageInstruction(dosage)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
        ...
        val dosage2 = Dosage()
        dosage2.timing.repeat.bounds = period2
        val testMedicationRequest9 = MedicationRequest()
            .addDosageInstruction(dosage2)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
    ...
    fun `retrieve multiple results with date param`() {
        ...
        val dosage = Dosage()
        dosage.timing.repeat.bounds = period
        val testMedicationRequest12 = MedicationRequest()
            .addDosageInstruction(dosage)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
        ...
        val dosage2 = Dosage()
        dosage2.timing.repeat.bounds = period2
        val testMedicationRequest13 = MedicationRequest()
            .addDosageInstruction(dosage2)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
    ...
    fun `retrieve multiple results with cerner date param`() {
        ...
        val dosage = Dosage()
        dosage.timing.repeat.bounds = period
        val testMedicationRequest14 = MedicationRequest()
            .addDosageInstruction(dosage)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
        ...
        val dosage2 = Dosage()
        dosage2.timing.repeat.bounds = period2
        val testMedicationRequest15 = MedicationRequest()
            .addDosageInstruction(dosage2)
            .setSubject(
                Reference().setReference(
                    "Patient/$testPatientId"
    ...
    fun `retrieve results with date param when some dosage periods are not in date range`() {
        ...
        val dosage3 = Dosage()
        dosage3.timing.repeat.bounds = period3
        val testMedicationRequest16 = MedicationRequest()
            .addDosageInstruction(dosage3)
            .addDosageInstruction(dosage2)
            .addDosageInstruction(dosage)
            .setSubject(
