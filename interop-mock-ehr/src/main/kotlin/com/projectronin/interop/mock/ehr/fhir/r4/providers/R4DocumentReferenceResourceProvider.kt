...
class R4DocumentReferenceResourceProvider(override var resourceDAO: R4DocumentReferenceDAO) :
    ...
    @Search
    fun search(
        @OptionalParam(name = DocumentReference.SP_PATIENT) patientReferenceParam: ReferenceParam? = null,
        @OptionalParam(name = DocumentReference.SP_SUBJECT) subjectReferenceParam: ReferenceParam? = null,
