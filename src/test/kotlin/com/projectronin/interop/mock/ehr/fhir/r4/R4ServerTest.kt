...
internal class R4ServerTest {
    ...
    fun `add resources correctly test`() {
        ...
        val server = R4Server(r4Patient, r4Appointment, r4Practitioner)
        server.init()
        assertTrue(server.resourceProviders.containsAll(listOf(r4Patient, r4Appointment, r4Practitioner)))
    }
}
